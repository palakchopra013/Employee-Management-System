...
//$sql = "SELECT COUNT(*) FROM `emp` WHERE usid='$usid' AND pass='$pass';";
//die();
$sql = "SELECT * FROM user WHERE username='$usid' AND password='$pass'";
$result = $conn->query($sql);
$result  = $result->fetch_assoc();
print_r($result); 
//echo "<script>console.log('WORKEDS')</script>"
...
header("location: index.php");
    ...
    echo "<p class='error'>User ID and/or Password are incorrect</p>";
...
if ($result->num_rows > 0) {
    ...
    echo "<p><strong>staus:</strong> " . $row["status"] . "</p>";
} else {
     Display error message
    echo "<p class='error'>User ID and/or Password are incorrect</p>";
}
...
<div class="signup-form">
    <form  method="POST">
        ...
        <div class="form-group">
			<div class="row">
				<div class="col"><input type="text" class="form-control" name="fname" placeholder="First Name" ></div>
